/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f9a2d95c20344ca2acbb641425200fda)
// Runtime types generated with workerd@1.20250823.0 2025-01-11 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ADMIN_KEY: string;
		JWT_SECRET: string;
		AUDIENCE_URL: string;
		SLIDE_ROOM: DurableObjectNamespace<import("./src/index").SlideRoom>;
		POLL_ROOM: DurableObjectNamespace<import("./src/index").PollRoom>;
		CONTAINER_STATUS: DurableObjectNamespace<import("./src/index").ContainerStatus>;
		DB: D1Database;
		VOTE_QUEUE: Queue;
	}
}
